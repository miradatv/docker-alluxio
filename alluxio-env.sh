...
ALLUXIO_WORKER_MEMORY_SIZE=${ALLUXIO_WORKER_MEMORY_SIZE:-"1024MB"}
ALLUXIO_RAM_FOLDER=${ALLUXIO_RAM_FOLDER:-"/tmp/alluxio"}
ALLUXIO_MASTER_MOUNT_TABLE_ROOT_UFS=${ALLUXIO_MASTER_MOUNT_TABLE_ROOT_UFS:-"${ALLUXIO_HOME}/underFSStorage/"}
